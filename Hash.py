...
my_phrases = ['A primeira das instituições criadas pelo Pe. Roberto Sabóia de Medeiros foi a antiga Escola Superior de Administração de Negócios de São Paulo - ESAN/SP.'
...
my_hashs = ['d24de3ec3835115c576a55188a31761b73af93ed2c45a171c810bb66b24b08f9'
...
my_md5 = ['c850e1a34a6ed572e0758ccd9c615bda'
          ,'b710771da8d7521524f45233ea9dd9e1'
          ,'55748c2cb669a9d9508677cb914cb02'
...
for i in range(len(my_phrases)):
    print('Teste ' + str(i+1) + ':\n')
    SHA256 = hashlib.sha256(my_phrases[i].encode('utf-8')).hexdigest()
    MD5 = hashlib.md5(my_phrases[i].encode('utf-8')).hexdigest()
    if SHA256 == my_hashs[i] and MD5 == my_md5[i]:
        print('SHA256 e MD5 corretos!')
        print(SHA256 + ' - ' + MD5 + '\n')
    elif SHA256 == my_hashs[i] and MD5 != my_md5[i]:
        ...
        print('Nenhum dos dois estão corretos!')
        print(SHA256 + ' - ' + MD5 + '\n')
